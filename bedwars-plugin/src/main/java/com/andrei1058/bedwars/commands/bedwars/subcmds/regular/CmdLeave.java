...
public class CmdLeave extends SubCommand {
    ...
    public CmdLeave(ParentCommand parent, String name) {
        ...
        setPriority(20);
        showInList(false);
        setDisplayInfo(com.andrei1058.bedwars.commands.bedwars.MainCommand.createTC("§8- §e/"+ MainCommand.getInstance().getName()+" leave", "/"+getParent().getName()+" "+getSubCommandName(), "§eLeave an arena."));
    }
