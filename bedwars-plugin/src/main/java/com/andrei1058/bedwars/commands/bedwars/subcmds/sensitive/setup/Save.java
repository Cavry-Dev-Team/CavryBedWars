...
public class Save extends SubCommand {
    ...
    public boolean execute(String[] args, CommandSender s) {
        ...
        p.spigot().sendMessage(Misc.msgHoverClick(ChatColor.AQUA + "/" + getParent().getName() + " enableArena " + ss.getWorldName() + ChatColor.GREEN +" (Click to enable)", ChatColor.YELLOW + "Enable this arena.", "/" + getParent().getName() + " enableArena " + ss.getWorldName(), ClickEvent.Action.RUN_COMMAND));
        return true;
    }
