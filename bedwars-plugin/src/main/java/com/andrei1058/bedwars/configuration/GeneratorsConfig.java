...
public class GeneratorsConfig extends ConfigManager {
    ...
    public GeneratorsConfig(Plugin plugin, String name, String dir) {
        ...
        yml.addDefault("Default." + ConfigPath.GENERATOR_IRON_DELAY, 0.3);
        yml.addDefault("Default." + ConfigPath.GENERATOR_IRON_AMOUNT, 2);
        yml.addDefault("Default." + ConfigPath.GENERATOR_GOLD_DELAY, 2);
        ...
        yml.addDefault("Default." + ConfigPath.GENERATOR_EMERALD_TIER_II_SPAWN_LIMIT, 4);
        ...
        yml.addDefault("Default." + ConfigPath.GENERATOR_EMERALD_TIER_III_SPAWN_LIMIT, 4);
