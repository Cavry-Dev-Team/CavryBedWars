...
public class MainConfig extends ConfigManager {
    ...
    public MainConfig(Plugin plugin, String name) {
        ...
        //
        yml.addDefault(ConfigPath.SB_CONFIG_SIDEBAR_USE_LOBBY_SIDEBAR, false);
        ...
        yml.addDefault(ConfigPath.GENERAL_CONFIG_PLACEHOLDERS_REPLACEMENTS_SERVER_IP, "cavrynet.work");
        ...
        saveSpectatorCommandItem("teleporter", "bw teleporter", false, getForCurrentVersion("COMPASS", "COMPASS", "COMPASS"), 0, 0);
        ...
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_EXPERIMENTAL_TEAM_ASSIGNER, false);
